      ...
      <Box sx={style.StartingPage}>
        <Box sx={style.AboutUsMainContainer}>
          <Box sx={style.AboutUsFirstContainer}>
            <Typography sx={style.AboutUsSecondContainerTitle}>
              ABOUT
            </Typography>
          </Box>
          <Grid sx={style.AboutUsSecondContainer}>
            <Box sx={{ width: "50%" }}>
              ...
              <Typography>
                We are currently the sole developers working on improving the
                Chess Academy website. As an active players and certified
                instructors, we created this platform to offer a space where we
                can control the content and share our learning materials with
                students. In the future, we plan to bring on others to help
                maintain and grow this idea of combining playing and learning
                chess in one place.
              </Typography>
            </Box>
            ...
            <Box>
              <img
                ...
                style={style.AboutUsContainerFirstImage}
              />
            </Box>
            ...
            <Box>
              <img
                ...
                style={style.AboutUsContainerSecondImage}
              />
